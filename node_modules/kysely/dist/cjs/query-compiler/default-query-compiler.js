...
class DefaultQueryCompiler extends operation_node_visitor_js_1.OperationNodeVisitor {
    ...
    visitInsertQuery(node) {
        const wrapInParens = this.parentNode !== undefined &&
            !parens_node_js_1.ParensNode.is(this.parentNode) &&
            !raw_node_js_1.RawNode.is(this.parentNode) &&
            !when_node_js_1.WhenNode.is(this.parentNode);
        if (this.parentNode === undefined && node.explain) {
            this.visitNode(node.explain);
            this.append(' ');
        }
        ...
        // TODO: remove in 0.29.
        if (node.ignore) {
            (0, log_once_js_1.logOnce)('`InsertQueryNode.ignore` is deprecated. Use `InsertQueryNode.orAction` instead.');
            this.append(' ignore');
        }
        if (node.orAction) {
            this.append(' ');
    ...
    appendImmediateValue(value) {
        ...
        else if ((0, object_utils_js_1.isNumber)(value) || (0, object_utils_js_1.isBoolean)(value) || (0, object_utils_js_1.isBigInt)(value)) {
