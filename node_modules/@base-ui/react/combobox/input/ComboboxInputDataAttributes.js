...
exports.ComboboxInputDataAttributes = void 0;
var _popupStateMapping = require("../../utils/popupStateMapping");
let ComboboxInputDataAttributes = exports.ComboboxInputDataAttributes = function (ComboboxInputDataAttributes) {
  /**
   * Present when the corresponding popup is open.
   */
  ComboboxInputDataAttributes[ComboboxInputDataAttributes["popupOpen"] = _popupStateMapping.CommonTriggerDataAttributes.popupOpen] = "popupOpen";
  /**
   * Present when the input is pressed.
   */
  ComboboxInputDataAttributes[ComboboxInputDataAttributes["pressed"] = _popupStateMapping.CommonTriggerDataAttributes.pressed] = "pressed";
  /**
