...
import * as better_call703 from "better-call";
...
declare const lastLoginMethod: <O extends LastLoginMethodOptions>(userConfig?: O | undefined) => {
  ...
  init(ctx: _better_auth_core36.AuthContext): {
    options: {
      databaseHooks: {
        user: {
          create: {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call703.MiddlewareInputContext<better_call703.MiddlewareOptions>) => Promise<void>;
    }[];
  };
