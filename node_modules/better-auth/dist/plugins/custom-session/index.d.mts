...
import * as better_call19 from "better-call";
...
declare const customSession: <Returns extends Record<string, any>, O extends BetterAuthOptions = BetterAuthOptions>(fn: (session: {
  ...
  hooks: {
    after: {
      matcher: (ctx: _better_auth_core5.HookEndpointContext) => boolean;
      handler: (inputContext: better_call19.MiddlewareInputContext<better_call19.MiddlewareOptions>) => Promise<Awaited<Returns>[] | undefined>;
    }[];
  };
  endpoints: {
    getSession: better_call19.StrictEndpoint<"/get-session", {
      method: "GET";
