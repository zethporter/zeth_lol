...
declare const backupCode2fa: (opts: BackupCodeOptions) => {
  ...
  endpoints: {
     ...
     */
    verifyBackupCode: better_call755.StrictEndpoint<"/two-factor/verify-backup-code", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
     ...
     */
    generateBackupCodes: better_call755.StrictEndpoint<"/two-factor/generate-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    viewBackupCodes: better_call755.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
