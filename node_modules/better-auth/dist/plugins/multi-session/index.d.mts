...
import * as better_call76 from "better-call";
...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: better_call76.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    }, {
      session: {
     ...
     */
    setActiveSession: better_call76.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
      requireHeaders: true;
      use: ((inputContext: better_call76.MiddlewareInputContext<better_call76.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    revokeDeviceSession: better_call76.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call76.MiddlewareInputContext<better_call76.MiddlewareOptions>) => Promise<void>;
    }[];
  };
