...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call2.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call2.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call2.MiddlewareInputContext<better_call2.MiddlewareOptions>) => Promise<void>;
    }[];
  };
