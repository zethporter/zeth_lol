...
declare const oAuthProxy: <O extends OAuthProxyOptions>(opts?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    oAuthProxy: better_call235.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call235.MiddlewareInputContext<better_call235.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
