...
import * as better_call949 from "better-call";
import * as z from "zod";

//#region src/plugins/organization/routes/crud-members.d.ts
declare const addMember: <O extends OrganizationOptions>(option: O) => better_call949.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
  ...
  use: ((inputContext: better_call949.MiddlewareInputContext<better_call949.MiddlewareOptions>) => Promise<{
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => better_call949.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call949.MiddlewareInputContext<{
    use: ((inputContext: better_call949.MiddlewareInputContext<better_call949.MiddlewareOptions>) => Promise<{
      session: {
...
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => better_call949.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => better_call949.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (((inputContext: better_call949.MiddlewareInputContext<better_call949.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => better_call949.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call949.MiddlewareInputContext<better_call949.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => better_call949.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => better_call949.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
