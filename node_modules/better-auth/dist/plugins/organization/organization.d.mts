...
declare const createHasPermission: <O extends OrganizationOptions>(options: O) => better_call746.StrictEndpoint<"/organization/has-permission", {
  method: "POST";
  requireHeaders: true;
  ...
  use: ((inputContext: better_call746.MiddlewareInputContext<{
