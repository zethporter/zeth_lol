import * as _better_auth_core_db145 from "@better-auth/core/db";
  ...
  apikey: {
    fields: {
      ...
      metadata: {
        ...
        input: true;
        transform: {
          input(value: _better_auth_core_db145.DBPrimitive): string;
          output(value: _better_auth_core_db145.DBPrimitive): any;
        };
      };
    };
  };
