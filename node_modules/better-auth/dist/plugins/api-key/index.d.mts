...
import * as better_call685 from "better-call";
import * as zod1848 from "zod";
import * as zod_v4_core263 from "zod/v4/core";
...
declare const apiKey: (options?: ApiKeyOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call685.MiddlewareInputContext<better_call685.MiddlewareOptions>) => Promise<{
        user: {
          id: string;
          createdAt: Date;
          updatedAt: Date;
        ...
        context: better_call685.MiddlewareContext<better_call685.MiddlewareOptions, {
          returned?: unknown | undefined;
          responseHeaders?: Headers | undefined;
        } & _better_auth_core24.PluginContext & _better_auth_core24.InfoContext & {
          options: _better_auth_core24.BetterAuthOptions;
          ...
          authCookies: _better_auth_core24.BetterAuthCookies;
          ...
          } & Omit<_better_auth_core24.BetterAuthRateLimitOptions, "enabled" | "window" | "max" | "storage">;
          adapter: _better_auth_core_db_adapter1.DBAdapter<_better_auth_core24.BetterAuthOptions>;
          internalAdapter: _better_auth_core24.InternalAdapter<_better_auth_core24.BetterAuthOptions>;
          createAuthCookie: (cookieName: string, overrideAttributes?: Partial<better_call685.CookieOptions> | undefined) => _better_auth_core24.BetterAuthCookie;
          secret: string;
          sessionConfig: {
            updateAge: number;
            expiresIn: number;
          ...
          password: {
            ...
            checkPassword: (userId: string, ctx: _better_auth_core24.GenericEndpointContext<_better_auth_core24.BetterAuthOptions>) => Promise<boolean>;
          };
  ...
  endpoints: {
     ...
     */
    createApiKey: better_call685.StrictEndpoint<"/api-key/create", {
      method: "POST";
      body: zod1848.ZodObject<{
        name: zod1848.ZodOptional<zod1848.ZodString>;
        expiresIn: zod1848.ZodDefault<zod1848.ZodNullable<zod1848.ZodOptional<zod1848.ZodNumber>>>;
        userId: zod1848.ZodOptional<zod1848.ZodCoercedString<unknown>>;
        prefix: zod1848.ZodOptional<zod1848.ZodString>;
        remaining: zod1848.ZodDefault<zod1848.ZodNullable<zod1848.ZodOptional<zod1848.ZodNumber>>>;
        metadata: zod1848.ZodOptional<zod1848.ZodAny>;
        refillAmount: zod1848.ZodOptional<zod1848.ZodNumber>;
        refillInterval: zod1848.ZodOptional<zod1848.ZodNumber>;
        rateLimitTimeWindow: zod1848.ZodOptional<zod1848.ZodNumber>;
        rateLimitMax: zod1848.ZodOptional<zod1848.ZodNumber>;
        rateLimitEnabled: zod1848.ZodOptional<zod1848.ZodBoolean>;
        permissions: zod1848.ZodOptional<zod1848.ZodRecord<zod1848.ZodString, zod1848.ZodArray<zod1848.ZodString>>>;
      }, zod_v4_core263.$strip>;
      metadata: {
        openapi: {
          description: string;
          responses: {
     ...
     */
    verifyApiKey: better_call685.StrictEndpoint<string, {
      method: "POST";
      body: zod1848.ZodObject<{
        key: zod1848.ZodString;
        permissions: zod1848.ZodOptional<zod1848.ZodRecord<zod1848.ZodString, zod1848.ZodArray<zod1848.ZodString>>>;
      }, zod_v4_core263.$strip>;
    }, {
      valid: boolean;
     ...
     */
    getApiKey: better_call685.StrictEndpoint<"/api-key/get", {
      method: "GET";
      query: zod1848.ZodObject<{
        id: zod1848.ZodString;
      }, zod_v4_core263.$strip>;
      use: ((inputContext: better_call685.MiddlewareInputContext<better_call685.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    updateApiKey: better_call685.StrictEndpoint<"/api-key/update", {
      method: "POST";
      body: zod1848.ZodObject<{
        keyId: zod1848.ZodString;
        userId: zod1848.ZodOptional<zod1848.ZodCoercedString<unknown>>;
        name: zod1848.ZodOptional<zod1848.ZodString>;
        enabled: zod1848.ZodOptional<zod1848.ZodBoolean>;
        remaining: zod1848.ZodOptional<zod1848.ZodNumber>;
        refillAmount: zod1848.ZodOptional<zod1848.ZodNumber>;
        refillInterval: zod1848.ZodOptional<zod1848.ZodNumber>;
        metadata: zod1848.ZodOptional<zod1848.ZodAny>;
        expiresIn: zod1848.ZodNullable<zod1848.ZodOptional<zod1848.ZodNumber>>;
        rateLimitEnabled: zod1848.ZodOptional<zod1848.ZodBoolean>;
        rateLimitTimeWindow: zod1848.ZodOptional<zod1848.ZodNumber>;
        rateLimitMax: zod1848.ZodOptional<zod1848.ZodNumber>;
        permissions: zod1848.ZodNullable<zod1848.ZodOptional<zod1848.ZodRecord<zod1848.ZodString, zod1848.ZodArray<zod1848.ZodString>>>>;
      }, zod_v4_core263.$strip>;
      metadata: {
        openapi: {
          description: string;
     ...
     */
    deleteApiKey: better_call685.StrictEndpoint<"/api-key/delete", {
      method: "POST";
      body: zod1848.ZodObject<{
        keyId: zod1848.ZodString;
      }, zod_v4_core263.$strip>;
     ...
     */
    listApiKeys: better_call685.StrictEndpoint<"/api-key/list", {
      method: "GET";
      use: ((inputContext: better_call685.MiddlewareInputContext<better_call685.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    deleteAllExpiredApiKeys: better_call685.StrictEndpoint<string, {
      method: "POST";
    }, {
      success: boolean;
      error: unknown;
