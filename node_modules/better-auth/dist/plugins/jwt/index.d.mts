...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: better_call49.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call49.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call49.MiddlewareInputContext<better_call49.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call49.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call49.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call49.MiddlewareInputContext<better_call49.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    jwks: {
