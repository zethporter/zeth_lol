...
import * as better_call831 from "better-call";
...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call831.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call831.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  use: ((inputContext: better_call831.MiddlewareInputContext<better_call831.MiddlewareOptions>) => Promise<void>)[];
  body: z.ZodObject<{
    email: z.ZodString;
