...
declare const signUpEmail: <O extends BetterAuthOptions>() => better_call816.StrictEndpoint<"/sign-up/email", {
  method: "POST";
  operationId: string;
  use: ((inputContext: better_call816.MiddlewareInputContext<better_call816.MiddlewareOptions>) => Promise<void>)[];
