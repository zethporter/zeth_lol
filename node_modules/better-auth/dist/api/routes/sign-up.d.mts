...
declare const signUpEmail: <O extends BetterAuthOptions>() => better_call836.StrictEndpoint<"/sign-up/email", {
  method: "POST";
  operationId: string;
  use: ((inputContext: better_call836.MiddlewareInputContext<better_call836.MiddlewareOptions>) => Promise<void>)[];
