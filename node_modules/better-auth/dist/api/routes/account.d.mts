...
declare const listUserAccounts: better_call768.StrictEndpoint<"/list-accounts", {
  method: "GET";
...
declare const linkSocialAccount: better_call768.StrictEndpoint<"/link-social", {
  method: "POST";
  requireHeaders: true;
  body: z.ZodObject<{
...
declare const unlinkAccount: better_call768.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call768.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call768.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call768.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call768.MiddlewareInputContext<better_call768.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
  ...
  user: _better_auth_core_oauth29.OAuth2UserInfo;
