...
class CollectionImpl {
  ...
  constructor(config) {
    ...
    this._changes = new changes.CollectionChangesManager();
    this._events = new events.CollectionEventsManager();
    this._indexes = new indexes.CollectionIndexesManager();
    this._lifecycle = new lifecycle.CollectionLifecycleManager(config, this.id);
    this._mutations = new mutations.CollectionMutationsManager(config, this.id);
    this._state = new state.CollectionStateManager(config);
    this._sync = new sync.CollectionSyncManager(config, this.id);
