...
let _tanstack_pacer_queuer = require("@tanstack/pacer/queuer");

//#region src/queuer/useQueuer.ts
/**
...
* ```
*/
function useQueuer(fn, options = {}, selector = () => ({})) {
	const mergedOptions = {
		...require_PacerProvider.useDefaultPacerOptions().queuer,
		...options
	};
	const [queuer] = (0, react.useState)(() => {
		const queuerInstance = new _tanstack_pacer_queuer.Queuer(fn, mergedOptions);
		queuerInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useStore)(queuerInstance.store, props.selector);
	...
	const state = (0, _tanstack_react_store.useStore)(queuer.store, selector);
...
//#endregion
exports.useQueuer = useQueuer;
//# sourceMappingURL=useQueuer.cjs.map