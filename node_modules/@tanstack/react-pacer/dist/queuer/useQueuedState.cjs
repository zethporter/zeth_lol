const require_useQueuer = require('./useQueuer.cjs');

//#region src/queuer/useQueuedState.ts
/**
...
* ```
*/
function useQueuedState(fn, options = {}, selector) {
	const queue = require_useQueuer.useQueuer(fn, options, selector);
	return [
		queue.state.items,
		queue.addItem,
		queue
...
//#endregion
exports.useQueuedState = useQueuedState;
//# sourceMappingURL=useQueuedState.cjs.map