import { ReactQueuer } from "./useQueuer.cjs";
import { QueuerOptions, QueuerState } from "@tanstack/pacer/queuer";

//#region src/queuer/useQueuedValue.d.ts
/**
 ...
 * ```
 */
declare function useQueuedValue<TValue, TSelected extends Pick<QueuerState<TValue>, 'items'> = Pick<QueuerState<TValue>, 'items'>>(initialValue: TValue, options?: QueuerOptions<TValue>, selector?: (state: QueuerState<TValue>) => TSelected): [TValue, ReactQueuer<TValue, TSelected>];
//#endregion
export { useQueuedValue };
//# sourceMappingURL=useQueuedValue.d.cts.map