...
//#region src/queuer/useQueuer.d.ts
interface ReactQueuer<TValue, TSelected = {}> extends Omit<Queuer<TValue>, 'store'> {
  /**
 ...
 * ```
 */
declare function useQueuer<TValue, TSelected = {}>(fn: (item: TValue) => void, options?: QueuerOptions<TValue>, selector?: (state: QueuerState<TValue>) => TSelected): ReactQueuer<TValue, TSelected>;
//#endregion
export { ReactQueuer, useQueuer };
//# sourceMappingURL=useQueuer.d.cts.map