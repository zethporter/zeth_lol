...
//#region src/queuer/useQueuedState.d.ts
/**
 ...
 * ```
 */
declare function useQueuedState<TValue, TSelected extends Pick<QueuerState<TValue>, 'items'> = Pick<QueuerState<TValue>, 'items'>>(fn: (item: TValue) => void, options?: QueuerOptions<TValue>, selector?: (state: QueuerState<TValue>) => TSelected): [Array<TValue>, Queuer<TValue>['addItem'], ReactQueuer<TValue, TSelected>];
//#endregion
export { useQueuedState };
//# sourceMappingURL=useQueuedState.d.cts.map