...
const require_useQueuedState = require('./useQueuedState.cjs');
let react = require("react");

//#region src/queuer/useQueuedValue.ts
/**
...
* ```
*/
function useQueuedValue(initialValue, options = {}, selector) {
	const [value, setValue] = (0, react.useState)(initialValue);
	const [, addItem, queuer] = require_useQueuedState.useQueuedState((item) => {
		setValue(item);
	}, options, selector);
	(0, react.useEffect)(() => {
...
//#endregion
exports.useQueuedValue = useQueuedValue;
//# sourceMappingURL=useQueuedValue.cjs.map