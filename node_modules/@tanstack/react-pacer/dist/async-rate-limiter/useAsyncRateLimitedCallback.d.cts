...
import { AsyncRateLimiterOptions } from "@tanstack/pacer/async-rate-limiter";

//#region src/async-rate-limiter/useAsyncRateLimitedCallback.d.ts
/**
 ...
 * ```
 */
declare function useAsyncRateLimitedCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: AsyncRateLimiterOptions<TFn>): (...args: Parameters<TFn>) => Promise<ReturnType<TFn>>;
//#endregion
export { useAsyncRateLimitedCallback };
//# sourceMappingURL=useAsyncRateLimitedCallback.d.cts.map