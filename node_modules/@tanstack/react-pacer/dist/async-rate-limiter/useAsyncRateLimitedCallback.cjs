...
const require_useAsyncRateLimiter = require('./useAsyncRateLimiter.cjs');
let react = require("react");

//#region src/async-rate-limiter/useAsyncRateLimitedCallback.ts
/**
...
* ```
*/
function useAsyncRateLimitedCallback(fn, options) {
	const asyncRateLimitedFn = require_useAsyncRateLimiter.useAsyncRateLimiter(fn, options).maybeExecute;
	return (0, react.useCallback)((...args) => asyncRateLimitedFn(...args), [asyncRateLimitedFn]);
}

//#endregion
exports.useAsyncRateLimitedCallback = useAsyncRateLimitedCallback;
//# sourceMappingURL=useAsyncRateLimitedCallback.cjs.map