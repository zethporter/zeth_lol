...
//#region src/async-rate-limiter/useAsyncRateLimiter.d.ts
interface ReactAsyncRateLimiter<TFn extends AnyAsyncFunction, TSelected = {}> extends Omit<AsyncRateLimiter<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useAsyncRateLimiter<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: AsyncRateLimiterOptions<TFn>, selector?: (state: AsyncRateLimiterState<TFn>) => TSelected): ReactAsyncRateLimiter<TFn, TSelected>;
//#endregion
export { ReactAsyncRateLimiter, useAsyncRateLimiter };
//# sourceMappingURL=useAsyncRateLimiter.d.cts.map