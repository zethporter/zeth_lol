...
interface ReactDebouncer<TFn extends AnyFunction, TSelected = {}> extends Omit<Debouncer<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useDebouncer<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: DebouncerOptions<TFn>, selector?: (state: DebouncerState<TFn>) => TSelected): ReactDebouncer<TFn, TSelected>;
//#endregion
export { ReactDebouncer, useDebouncer };
//# sourceMappingURL=useDebouncer.d.cts.map