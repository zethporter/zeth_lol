...
const require_useDebouncedState = require('./useDebouncedState.cjs');
let react = require("react");

//#region src/debouncer/useDebouncedValue.ts
/**
...
* ```
*/
function useDebouncedValue(value, options, selector) {
	const [debouncedValue, setDebouncedValue, debouncer] = require_useDebouncedState.useDebouncedState(value, options, selector);
	(0, react.useEffect)(() => {
