import { ReactDebouncer } from "./useDebouncer.cjs";
import { DebouncerOptions, DebouncerState } from "@tanstack/pacer/debouncer";

//#region src/debouncer/useDebouncedState.d.ts
/**
 ...
 * ```
 */
declare function useDebouncedState<TValue, TSelected = DebouncerState<React.Dispatch<React.SetStateAction<TValue>>>>(value: TValue, options: DebouncerOptions<React.Dispatch<React.SetStateAction<TValue>>>, selector?: (state: DebouncerState<React.Dispatch<React.SetStateAction<TValue>>>) => TSelected): [TValue, React.Dispatch<React.SetStateAction<TValue>>, ReactDebouncer<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
export { useDebouncedState };
//# sourceMappingURL=useDebouncedState.d.cts.map