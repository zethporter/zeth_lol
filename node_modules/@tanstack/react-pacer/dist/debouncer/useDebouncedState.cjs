...
//#region src/debouncer/useDebouncedState.ts
/**
...
* ```
*/
function useDebouncedState(value, options, selector) {
	const [debouncedValue, setDebouncedValue] = (0, react.useState)(value);
	const debouncer = require_useDebouncer.useDebouncer(setDebouncedValue, options, selector);
	return [
		debouncedValue,
