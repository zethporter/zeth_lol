...
const require_useDebouncer = require('./useDebouncer.cjs');
let react = require("react");

//#region src/debouncer/useDebouncedCallback.ts
/**
...
* ```
*/
function useDebouncedCallback(fn, options) {
	const debouncedFn = require_useDebouncer.useDebouncer(fn, options).maybeExecute;
	return (0, react.useCallback)((...args) => debouncedFn(...args), [debouncedFn]);
}

//#endregion
exports.useDebouncedCallback = useDebouncedCallback;
//# sourceMappingURL=useDebouncedCallback.cjs.map