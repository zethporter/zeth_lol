...
function useDebouncer(fn, options, selector = () => ({})) {
	...
	const [debouncer] = (0, react.useState)(() => {
		...
		debouncerInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useStore)(debouncerInstance.store, props.selector);
	...
	const state = (0, _tanstack_react_store.useStore)(debouncer.store, selector);
...
//# sourceMappingURL=useDebouncer.cjs.map