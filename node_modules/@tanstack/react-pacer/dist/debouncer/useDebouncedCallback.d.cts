...
import { DebouncerOptions } from "@tanstack/pacer/debouncer";

//#region src/debouncer/useDebouncedCallback.d.ts
/**
 ...
 * ```
 */
declare function useDebouncedCallback<TFn extends AnyFunction>(fn: TFn, options: DebouncerOptions<TFn>): (...args: Parameters<TFn>) => void;
//#endregion
export { useDebouncedCallback };
//# sourceMappingURL=useDebouncedCallback.d.cts.map