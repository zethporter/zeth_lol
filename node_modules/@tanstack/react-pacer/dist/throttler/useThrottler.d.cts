...
//#region src/throttler/useThrottler.d.ts
interface ReactThrottler<TFn extends AnyFunction, TSelected = {}> extends Omit<Throttler<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useThrottler<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: ThrottlerOptions<TFn>, selector?: (state: ThrottlerState<TFn>) => TSelected): ReactThrottler<TFn, TSelected>;
//#endregion
export { ReactThrottler, useThrottler };
//# sourceMappingURL=useThrottler.d.cts.map