...
const require_useThrottler = require('./useThrottler.cjs');
let react = require("react");

//#region src/throttler/useThrottledCallback.ts
/**
...
* ```
*/
function useThrottledCallback(fn, options) {
	const throttledFn = require_useThrottler.useThrottler(fn, options).maybeExecute;
	return (0, react.useCallback)((...args) => throttledFn(...args), [throttledFn]);
}

//#endregion
exports.useThrottledCallback = useThrottledCallback;
//# sourceMappingURL=useThrottledCallback.cjs.map