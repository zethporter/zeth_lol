...
//#region src/throttler/useThrottledCallback.d.ts
/**
 ...
 * ```
 */
declare function useThrottledCallback<TFn extends AnyFunction>(fn: TFn, options: ThrottlerOptions<TFn>): (...args: Parameters<TFn>) => void;
//#endregion
export { useThrottledCallback };
//# sourceMappingURL=useThrottledCallback.d.cts.map