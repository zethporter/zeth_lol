...
//#region src/throttler/useThrottledState.ts
/**
...
* ```
*/
function useThrottledState(value, options, selector) {
	const [throttledValue, setThrottledValue] = (0, react.useState)(value);
	const throttler = require_useThrottler.useThrottler(setThrottledValue, options, selector);
	return [
		throttledValue,
...
//# sourceMappingURL=useThrottledState.cjs.map