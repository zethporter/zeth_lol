import { ReactThrottler } from "./useThrottler.cjs";
import { ThrottlerOptions, ThrottlerState } from "@tanstack/pacer/throttler";

//#region src/throttler/useThrottledState.d.ts
/**
 ...
 * ```
 */
declare function useThrottledState<TValue, TSelected = ThrottlerState<React.Dispatch<React.SetStateAction<TValue>>>>(value: TValue, options: ThrottlerOptions<React.Dispatch<React.SetStateAction<TValue>>>, selector?: (state: ThrottlerState<React.Dispatch<React.SetStateAction<TValue>>>) => TSelected): [TValue, React.Dispatch<React.SetStateAction<TValue>>, ReactThrottler<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
export { useThrottledState };
//# sourceMappingURL=useThrottledState.d.cts.map