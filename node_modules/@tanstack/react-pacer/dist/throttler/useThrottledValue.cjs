...
const require_useThrottledState = require('./useThrottledState.cjs');
let react = require("react");

//#region src/throttler/useThrottledValue.ts
/**
...
* ```
*/
function useThrottledValue(value, options, selector) {
	const [throttledValue, setThrottledValue, throttler] = require_useThrottledState.useThrottledState(value, options, selector);
	(0, react.useEffect)(() => {
...
//# sourceMappingURL=useThrottledValue.cjs.map