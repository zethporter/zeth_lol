...
//#region src/rate-limiter/useRateLimiter.ts
/**
...
* ```
*/
function useRateLimiter(fn, options, selector = () => ({})) {
	const mergedOptions = {
		...useDefaultPacerOptions().rateLimiter,
		...options
	};
	const [rateLimiter] = useState(() => {
		const rateLimiterInstance = new RateLimiter(fn, mergedOptions);
		rateLimiterInstance.Subscribe = function Subscribe(props) {
...
//# sourceMappingURL=useRateLimiter.js.map