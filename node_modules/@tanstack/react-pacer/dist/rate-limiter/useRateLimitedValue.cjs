...
const require_useRateLimitedState = require('./useRateLimitedState.cjs');
let react = require("react");

//#region src/rate-limiter/useRateLimitedValue.ts
/**
...
* ```
*/
function useRateLimitedValue(value, options, selector) {
	const [rateLimitedValue, setRateLimitedValue, rateLimiter] = require_useRateLimitedState.useRateLimitedState(value, options, selector);
	(0, react.useEffect)(() => {
...
//#endregion
exports.useRateLimitedValue = useRateLimitedValue;
//# sourceMappingURL=useRateLimitedValue.cjs.map