...
//#region src/rate-limiter/useRateLimiter.d.ts
interface ReactRateLimiter<TFn extends AnyFunction, TSelected = {}> extends Omit<RateLimiter<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useRateLimiter<TFn extends AnyFunction, TSelected = {}>(fn: TFn, options: RateLimiterOptions<TFn>, selector?: (state: RateLimiterState) => TSelected): ReactRateLimiter<TFn, TSelected>;
//#endregion
export { ReactRateLimiter, useRateLimiter };
//# sourceMappingURL=useRateLimiter.d.cts.map