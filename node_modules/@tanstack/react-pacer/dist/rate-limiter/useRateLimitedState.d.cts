import { ReactRateLimiter } from "./useRateLimiter.cjs";
import { RateLimiterOptions, RateLimiterState } from "@tanstack/pacer/rate-limiter";

//#region src/rate-limiter/useRateLimitedState.d.ts
/**
 ...
 * ```
 */
declare function useRateLimitedState<TValue, TSelected = RateLimiterState>(value: TValue, options: RateLimiterOptions<React.Dispatch<React.SetStateAction<TValue>>>, selector?: (state: RateLimiterState) => TSelected): [TValue, React.Dispatch<React.SetStateAction<TValue>>, ReactRateLimiter<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
export { useRateLimitedState };
//# sourceMappingURL=useRateLimitedState.d.cts.map