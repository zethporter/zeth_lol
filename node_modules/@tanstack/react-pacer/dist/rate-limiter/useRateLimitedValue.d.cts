...
//#region src/rate-limiter/useRateLimitedValue.d.ts
/**
 ...
 * ```
 */
declare function useRateLimitedValue<TValue, TSelected = RateLimiterState>(value: TValue, options: RateLimiterOptions<React.Dispatch<React.SetStateAction<TValue>>>, selector?: (state: RateLimiterState) => TSelected): [TValue, ReactRateLimiter<React.Dispatch<React.SetStateAction<TValue>>, TSelected>];
//#endregion
export { useRateLimitedValue };
//# sourceMappingURL=useRateLimitedValue.d.cts.map