...
const require_useRateLimiter = require('./useRateLimiter.cjs');
let react = require("react");

//#region src/rate-limiter/useRateLimitedState.ts
/**
...
* ```
*/
function useRateLimitedState(value, options, selector) {
	const [rateLimitedValue, setRateLimitedValue] = (0, react.useState)(value);
	const rateLimiter = require_useRateLimiter.useRateLimiter(setRateLimitedValue, options, selector);
	return [
		rateLimitedValue,
...
//#endregion
exports.useRateLimitedState = useRateLimitedState;
//# sourceMappingURL=useRateLimitedState.cjs.map