...
//#region src/rate-limiter/useRateLimitedCallback.ts
/**
...
* ```
*/
function useRateLimitedCallback(fn, options) {
	const rateLimitedFn = require_useRateLimiter.useRateLimiter(fn, options).maybeExecute;
	return (0, react.useCallback)((...args) => rateLimitedFn(...args), [rateLimitedFn]);
}

//#endregion
exports.useRateLimitedCallback = useRateLimitedCallback;
//# sourceMappingURL=useRateLimitedCallback.cjs.map