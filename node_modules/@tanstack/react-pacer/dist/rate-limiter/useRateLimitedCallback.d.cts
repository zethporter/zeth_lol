...
import { RateLimiterOptions } from "@tanstack/pacer/rate-limiter";

//#region src/rate-limiter/useRateLimitedCallback.d.ts
/**
 ...
 * ```
 */
declare function useRateLimitedCallback<TFn extends AnyFunction>(fn: TFn, options: RateLimiterOptions<TFn>): (...args: Parameters<TFn>) => boolean;
//#endregion
export { useRateLimitedCallback };
//# sourceMappingURL=useRateLimitedCallback.d.cts.map