...
//#region src/async-debouncer/useAsyncDebouncer.d.ts
interface ReactAsyncDebouncer<TFn extends AnyAsyncFunction, TSelected = {}> extends Omit<AsyncDebouncer<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useAsyncDebouncer<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: AsyncDebouncerOptions<TFn>, selector?: (state: AsyncDebouncerState<TFn>) => TSelected): ReactAsyncDebouncer<TFn, TSelected>;
//#endregion
export { ReactAsyncDebouncer, useAsyncDebouncer };
//# sourceMappingURL=useAsyncDebouncer.d.cts.map