...
import { AsyncDebouncerOptions } from "@tanstack/pacer/async-debouncer";

//#region src/async-debouncer/useAsyncDebouncedCallback.d.ts
/**
 ...
 * ```
 */
declare function useAsyncDebouncedCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: AsyncDebouncerOptions<TFn>): (...args: Parameters<TFn>) => Promise<ReturnType<TFn>>;
//#endregion
export { useAsyncDebouncedCallback };
//# sourceMappingURL=useAsyncDebouncedCallback.d.cts.map