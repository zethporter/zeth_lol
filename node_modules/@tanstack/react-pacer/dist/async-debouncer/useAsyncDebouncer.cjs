...
let _tanstack_pacer_async_debouncer = require("@tanstack/pacer/async-debouncer");

//#region src/async-debouncer/useAsyncDebouncer.ts
/**
...
* ```
*/
function useAsyncDebouncer(fn, options, selector = () => ({})) {
	const mergedOptions = {
		...require_PacerProvider.useDefaultPacerOptions().asyncDebouncer,
		...options
	};
	const [asyncDebouncer] = (0, react.useState)(() => {
		const asyncDebouncerInstance = new _tanstack_pacer_async_debouncer.AsyncDebouncer(fn, mergedOptions);
		asyncDebouncerInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useStore)(asyncDebouncerInstance.store, props.selector);
	...
	const state = (0, _tanstack_react_store.useStore)(asyncDebouncer.store, selector);
	(0, react.useEffect)(() => {
		return () => {
...
//#endregion
exports.useAsyncDebouncer = useAsyncDebouncer;
//# sourceMappingURL=useAsyncDebouncer.cjs.map