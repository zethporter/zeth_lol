import { AsyncBatcherOptions } from "@tanstack/pacer/async-batcher";
import { AnyAsyncFunction } from "@tanstack/pacer/types";

//#region src/async-batcher/useAsyncBatchedCallback.d.ts
 ...
 * ```
 */
declare function useAsyncBatchedCallback<TFn extends AnyAsyncFunction>(fn: (items: Array<Parameters<TFn>[0]>) => Promise<any>, options: AsyncBatcherOptions<Parameters<TFn>[0]>): (...args: Parameters<TFn>) => Promise<void>;
//#endregion
export { useAsyncBatchedCallback };
//# sourceMappingURL=useAsyncBatchedCallback.d.cts.map