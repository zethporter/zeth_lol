...
let _tanstack_pacer_async_batcher = require("@tanstack/pacer/async-batcher");
let _tanstack_react_store = require("@tanstack/react-store");

//#region src/async-batcher/useAsyncBatcher.ts
/**
...
* ```
*/
function useAsyncBatcher(fn, options = {}, selector = () => ({})) {
	const mergedOptions = {
		...require_PacerProvider.useDefaultPacerOptions().asyncBatcher,
		...options
	};
	const [asyncBatcher] = (0, react.useState)(() => {
		const asyncBatcherInstance = new _tanstack_pacer_async_batcher.AsyncBatcher(fn, mergedOptions);
		asyncBatcherInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useStore)(asyncBatcherInstance.store, props.selector);
	...
	const state = (0, _tanstack_react_store.useStore)(asyncBatcher.store, selector);
...
//#endregion
exports.useAsyncBatcher = useAsyncBatcher;
//# sourceMappingURL=useAsyncBatcher.cjs.map