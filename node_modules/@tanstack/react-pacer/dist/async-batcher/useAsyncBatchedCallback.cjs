...
const require_useAsyncBatcher = require('./useAsyncBatcher.cjs');
let react = require("react");

//#region src/async-batcher/useAsyncBatchedCallback.ts
/**
...
* ```
*/
function useAsyncBatchedCallback(fn, options) {
	const asyncBatchedFn = require_useAsyncBatcher.useAsyncBatcher(fn, options).addItem;
...
//#endregion
exports.useAsyncBatchedCallback = useAsyncBatchedCallback;
//# sourceMappingURL=useAsyncBatchedCallback.cjs.map