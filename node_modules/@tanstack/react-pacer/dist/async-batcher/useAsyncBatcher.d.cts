...
//#region src/async-batcher/useAsyncBatcher.d.ts
interface ReactAsyncBatcher<TValue, TSelected = {}> extends Omit<AsyncBatcher<TValue>, 'store'> {
  /**
 ...
 * ```
 */
declare function useAsyncBatcher<TValue, TSelected = {}>(fn: (items: Array<TValue>) => Promise<any>, options?: AsyncBatcherOptions<TValue>, selector?: (state: AsyncBatcherState<TValue>) => TSelected): ReactAsyncBatcher<TValue, TSelected>;
//#endregion
export { ReactAsyncBatcher, useAsyncBatcher };
//# sourceMappingURL=useAsyncBatcher.d.cts.map