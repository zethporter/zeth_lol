const require_useAsyncQueuer = require('./useAsyncQueuer.cjs');

//#region src/async-queuer/useAsyncQueuedState.ts
/**
...
* ```
*/
function useAsyncQueuedState(fn, options = {}, selector) {
	const asyncQueuer = require_useAsyncQueuer.useAsyncQueuer(fn, options, selector);
	return [asyncQueuer.state.items, asyncQueuer];
}

//#endregion
exports.useAsyncQueuedState = useAsyncQueuedState;
//# sourceMappingURL=useAsyncQueuedState.cjs.map