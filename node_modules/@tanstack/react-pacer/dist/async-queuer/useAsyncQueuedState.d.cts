import { ReactAsyncQueuer } from "./useAsyncQueuer.cjs";
import { AsyncQueuerOptions, AsyncQueuerState } from "@tanstack/pacer/async-queuer";

//#region src/async-queuer/useAsyncQueuedState.d.ts
/**
 ...
 * ```
 */
declare function useAsyncQueuedState<TValue, TSelected extends Pick<AsyncQueuerState<TValue>, 'items'> = Pick<AsyncQueuerState<TValue>, 'items'>>(fn: (value: TValue) => Promise<any>, options?: AsyncQueuerOptions<TValue>, selector?: (state: AsyncQueuerState<TValue>) => TSelected): [Array<TValue>, ReactAsyncQueuer<TValue, TSelected>];
//#endregion
export { useAsyncQueuedState };
//# sourceMappingURL=useAsyncQueuedState.d.cts.map