...
//#region src/async-queuer/useAsyncQueuer.d.ts
interface ReactAsyncQueuer<TValue, TSelected = {}> extends Omit<AsyncQueuer<TValue>, 'store'> {
  /**
 ...
 * ```
 */
declare function useAsyncQueuer<TValue, TSelected = {}>(fn: (value: TValue) => Promise<any>, options?: AsyncQueuerOptions<TValue>, selector?: (state: AsyncQueuerState<TValue>) => TSelected): ReactAsyncQueuer<TValue, TSelected>;
//#endregion
export { ReactAsyncQueuer, useAsyncQueuer };
//# sourceMappingURL=useAsyncQueuer.d.cts.map