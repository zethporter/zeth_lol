...
const require_useAsyncThrottler = require('./useAsyncThrottler.cjs');
let react = require("react");

//#region src/async-throttler/useAsyncThrottledCallback.ts
/**
...
* ```
*/
function useAsyncThrottledCallback(fn, options) {
	const asyncThrottledFn = require_useAsyncThrottler.useAsyncThrottler(fn, options).maybeExecute;
	return (0, react.useCallback)((...args) => asyncThrottledFn(...args), [asyncThrottledFn]);
}

//#endregion
exports.useAsyncThrottledCallback = useAsyncThrottledCallback;
//# sourceMappingURL=useAsyncThrottledCallback.cjs.map