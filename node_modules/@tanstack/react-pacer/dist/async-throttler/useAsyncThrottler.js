...
//#region src/async-throttler/useAsyncThrottler.ts
/**
...
* ```
*/
function useAsyncThrottler(fn, options, selector = () => ({})) {
	const mergedOptions = {
		...useDefaultPacerOptions().asyncThrottler,
		...options
	};
	const [asyncThrottler] = useState(() => {
		const asyncThrottlerInstance = new AsyncThrottler(fn, mergedOptions);
		asyncThrottlerInstance.Subscribe = function Subscribe(props) {
...
//#endregion
export { useAsyncThrottler };
//# sourceMappingURL=useAsyncThrottler.js.map