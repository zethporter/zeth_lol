...
import { AsyncThrottlerOptions } from "@tanstack/pacer/async-throttler";

//#region src/async-throttler/useAsyncThrottledCallback.d.ts
/**
 ...
 * ```
 */
declare function useAsyncThrottledCallback<TFn extends AnyAsyncFunction>(fn: TFn, options: AsyncThrottlerOptions<TFn>): (...args: Parameters<TFn>) => Promise<ReturnType<TFn>>;
//#endregion
export { useAsyncThrottledCallback };
//# sourceMappingURL=useAsyncThrottledCallback.d.cts.map