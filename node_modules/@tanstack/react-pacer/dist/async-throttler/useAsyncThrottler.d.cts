...
//#region src/async-throttler/useAsyncThrottler.d.ts
interface ReactAsyncThrottler<TFn extends AnyAsyncFunction, TSelected = {}> extends Omit<AsyncThrottler<TFn>, 'store'> {
  /**
 ...
 * ```
 */
declare function useAsyncThrottler<TFn extends AnyAsyncFunction, TSelected = {}>(fn: TFn, options: AsyncThrottlerOptions<TFn>, selector?: (state: AsyncThrottlerState<TFn>) => TSelected): ReactAsyncThrottler<TFn, TSelected>;
//#endregion
export { ReactAsyncThrottler, useAsyncThrottler };
//# sourceMappingURL=useAsyncThrottler.d.cts.map