...
* ```
*/
function useBatcher(fn, options = {}, selector = () => ({})) {
	const mergedOptions = {
		...require_PacerProvider.useDefaultPacerOptions().batcher,
		...options
	};
	const [batcher] = (0, react.useState)(() => {
		...
		batcherInstance.Subscribe = function Subscribe(props) {
			const selected = (0, _tanstack_react_store.useStore)(batcherInstance.store, props.selector);
	...
	const state = (0, _tanstack_react_store.useStore)(batcher.store, selector);
...
//# sourceMappingURL=useBatcher.cjs.map