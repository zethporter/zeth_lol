...
const require_useBatcher = require('./useBatcher.cjs');
let react = require("react");

//#region src/batcher/useBatchedCallback.ts
/**
...
* ```
*/
function useBatchedCallback(fn, options) {
	const batchedFn = require_useBatcher.useBatcher(fn, options).addItem;
	return (0, react.useCallback)((...args) => batchedFn(args[0]), [batchedFn]);
}

//#endregion
exports.useBatchedCallback = useBatchedCallback;
