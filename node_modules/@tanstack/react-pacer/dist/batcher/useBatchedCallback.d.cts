...
import { BatcherOptions } from "@tanstack/pacer/batcher";
 ...
 * ```
 */
declare function useBatchedCallback<TFn extends AnyFunction>(fn: (items: Array<Parameters<TFn>[0]>) => void, options: BatcherOptions<Parameters<TFn>[0]>): (...args: Parameters<TFn>) => void;
//#endregion
export { useBatchedCallback };
//# sourceMappingURL=useBatchedCallback.d.cts.map