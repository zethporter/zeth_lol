...
interface ReactBatcher<TValue, TSelected = {}> extends Omit<Batcher<TValue>, 'store'> {
  /**
 ...
 * ```
 */
declare function useBatcher<TValue, TSelected = {}>(fn: (items: Array<TValue>) => void, options?: BatcherOptions<TValue>, selector?: (state: BatcherState<TValue>) => TSelected): ReactBatcher<TValue, TSelected>;
//#endregion
export { ReactBatcher, useBatcher };
//# sourceMappingURL=useBatcher.d.cts.map