...
class ClientEventBus {
  ...
  constructor({
    ...
    this.#broadcastChannel.onmessage = (e) => {
      this.emitToClients(json.parseWithBigInt(e.data), true);
    };
  ...
  handleEventReceived(data) {
    try {
      const event = json.parseWithBigInt(data);
      this.emitToClients(event);
    } catch {
    }
  }
