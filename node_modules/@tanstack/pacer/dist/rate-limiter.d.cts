 ...
 */
interface RateLimiterOptions<TFn extends AnyFunction> {
  /**
 ...
 */
declare function rateLimiterOptions<TFn extends AnyFunction = AnyFunction, TOptions extends Partial<RateLimiterOptions<TFn>> = Partial<RateLimiterOptions<TFn>>>(options: TOptions): TOptions;
/**
 ...
 * ```
 */
declare class RateLimiter<TFn extends AnyFunction> {
  #private;
  fn: TFn;
 ...
 * ```
 */
declare function rateLimit<TFn extends AnyFunction>(fn: TFn, initialOptions: RateLimiterOptions<TFn>): (...args: Parameters<TFn>) => boolean;
//#endregion
export { RateLimiter, RateLimiterOptions, RateLimiterState, rateLimit, rateLimiterOptions };
//# sourceMappingURL=rate-limiter.d.cts.map