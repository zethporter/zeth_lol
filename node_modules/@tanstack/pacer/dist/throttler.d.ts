...
//#region src/throttler.d.ts
interface ThrottlerState<TFn extends AnyFunction> {
  /**
 ...
 */
interface ThrottlerOptions<TFn extends AnyFunction> {
  /**
 ...
 */
declare function throttlerOptions<TFn extends AnyFunction = AnyFunction, TOptions extends Partial<ThrottlerOptions<TFn>> = Partial<ThrottlerOptions<TFn>>>(options: TOptions): TOptions;
/**
 ...
 * ```
 */
declare class Throttler<TFn extends AnyFunction> {
  #private;
  fn: TFn;
 ...
 * ```
 */
declare function throttle<TFn extends AnyFunction>(fn: TFn, initialOptions: ThrottlerOptions<TFn>): (...args: Parameters<TFn>) => void;
//#endregion
export { Throttler, ThrottlerOptions, ThrottlerState, throttle, throttlerOptions };
