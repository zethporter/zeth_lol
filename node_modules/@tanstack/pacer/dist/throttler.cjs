...
var Throttler = class {
	...
	constructor(fn, initialOptions) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultThrottlerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-Throttler", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("Throttler", this);
	};
	#getEnabled = () => {
...
exports.throttlerOptions = throttlerOptions;
