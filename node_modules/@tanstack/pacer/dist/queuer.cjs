...
var Queuer = class {
	...
	constructor(fn, initialOptions = {}) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultQueuerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-Queuer", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("Queuer", this);
	};
	/**
...
exports.queue = queue;
exports.queuerOptions = queuerOptions;
