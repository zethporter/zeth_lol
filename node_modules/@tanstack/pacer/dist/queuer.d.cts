 ...
 */
declare function queuerOptions<TValue = any, TOptions extends Partial<QueuerOptions<TValue>> = Partial<QueuerOptions<TValue>>>(options: TOptions): TOptions;
/**
 ...
 * ```
 */
declare function queue<TValue>(fn: (item: TValue) => void, initialOptions: QueuerOptions<TValue>): (item: TValue, position?: QueuePosition, runOnItemsChange?: boolean) => boolean;
//#endregion
export { QueuePosition, Queuer, QueuerOptions, QueuerState, queue, queuerOptions };
//# sourceMappingURL=queuer.d.cts.map