 ...
 * ```
 */
declare function batch<TValue>(fn: (items: Array<TValue>) => void, options: BatcherOptions<TValue>): (item: TValue) => void;
//#endregion
export { Batcher, BatcherOptions, BatcherState, batch };
