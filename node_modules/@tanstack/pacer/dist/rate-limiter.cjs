...
var RateLimiter = class {
	...
	constructor(fn, initialOptions) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultRateLimiterState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-RateLimiter", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("RateLimiter", this);
	};
	/**
...
exports.rateLimiterOptions = rateLimiterOptions;
