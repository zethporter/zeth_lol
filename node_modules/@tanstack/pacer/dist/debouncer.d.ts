...
interface DebouncerState<TFn extends AnyFunction> {
  /**
 ...
 */
interface DebouncerOptions<TFn extends AnyFunction> {
  /**
 ...
 */
declare function debouncerOptions<TFn extends AnyFunction = AnyFunction, TOptions extends Partial<DebouncerOptions<TFn>> = Partial<DebouncerOptions<TFn>>>(options: TOptions): TOptions;
/**
 ...
 * ```
 */
declare class Debouncer<TFn extends AnyFunction> {
  #private;
  fn: TFn;
 ...
 * ```
 */
declare function debounce<TFn extends AnyFunction>(fn: TFn, initialOptions: DebouncerOptions<TFn>): (...args: Parameters<TFn>) => void;
//#endregion
export { Debouncer, DebouncerOptions, DebouncerState, debounce, debouncerOptions };
