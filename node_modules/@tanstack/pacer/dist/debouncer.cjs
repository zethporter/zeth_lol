...
var Debouncer = class {
	...
	constructor(fn, initialOptions) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultDebouncerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-Debouncer", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("Debouncer", this);
	};
	/**
...
exports.debouncerOptions = debouncerOptions;
