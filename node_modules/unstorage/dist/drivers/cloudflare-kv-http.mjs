...
import { createError, createRequiredError, defineDriver, joinKeys } from "./utils/index.mjs";
...
export default defineDriver((opts) => {
	...
	if ("apiToken" in opts) {
		...
		throw createError(DRIVER_NAME, "One of the `apiToken`, `userServiceKey`, or a combination of `email` and `apiKey` is required.");
	}
